    ...
    if (!holoEnabled) {
      if (typeof DeviceOrientationEvent !== 'undefined' &&
        ...
        try {
          ...
          if (permission === 'granted') { localStorage.setItem('holo_enabled', 'true'); setHoloEnabled(true); }
        } catch (e) { localStorage.setItem('holo_enabled', 'true'); setHoloEnabled(true); }
      } else { localStorage.setItem('holo_enabled', 'true'); setHoloEnabled(true); }
    } else { localStorage.setItem('holo_enabled', 'false'); setHoloEnabled(false); }
  };
    ...
    <div className="px-5 pt-8 pb-8">
      ...
      <div className="flex items-center justify-between bg-white rounded-2xl px-4 py-3 mb-3 border border-gray-100">
        ...
        <button onClick={toggleHolo} style={{
          ...
          position: 'relative', transition: 'background 0.2s', border: 'none', cursor: 'pointer', flexShrink: 0,
        }}>
          <div style={{
