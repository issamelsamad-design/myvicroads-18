        ...
        {isOpen && (
          ...
          >
            <div className="px-6 py-4">
              <p className="text-gray-600 text-sm">Address details will appear here.</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
...
export default function AddressesModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto mt-2">
        <AccordionItem icon={Home} title="Addresses" />
      </div>
    </motion.div>
  );
}
